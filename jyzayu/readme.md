...
- 댓글에 작성일과 작성자 이름, 댓글 내용을 출력하며 작성자 이름에 이메일 링크를 답니다.
...
해당 post부터 다른 user가 작성한 post이기 때문에 그룹화 기능이 됩니다.

### 최적화에 필요한 기능 리스팅
첨부 파일(Attachment)은 Document Store를 고려해야 합니다. 첨부 파일은 Posting이 작성된 후 레코드가 추가되며 변경이 거의 없습니다. 또한 많은 양이 아니기 때문에 하나의 필드에 저장할수 있습니다.
